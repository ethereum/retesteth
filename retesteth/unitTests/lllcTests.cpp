...
{
    // (SHA3 12 5)  ???
    string lllccode = "{(ADDRESS) (BALANCE 1) (ORIGIN) (CALLER) (CALLVALUE) (CALLDATALOAD 0) (CALLDATASIZE) (CALLDATACOPY 1 2 3) (CODESIZE) (CODECOPY 1 2 3) (GASPRICE) (EXTCODESIZE 1) (EXTCODECOPY 1 2 3 4) (RETURNDATASIZE) (RETURNDATACOPY 1 2 3)}";
    lllccode = replaceCode(lllccode);
    ETH_FAIL_REQUIRE(lllccode == "0x305060013150325033503450600035503650600360026001373850600360026001393a5060013b5060046003600260013c3d506003600260013e00");
}
