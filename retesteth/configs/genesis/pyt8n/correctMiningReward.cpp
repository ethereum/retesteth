...
{
genRewardsCfgPYT8N::genRewardsCfgPYT8N()
{
const string pyt8n_correctMiningReward_config = R"({
    ...
    spDataObject obj;
    (*obj)["path"] = "pyt8n/genesis/correctMiningReward.json";
    (*obj)["content"] = pyt8n_correctMiningReward_config;
